    ...
    return (
        <section className="w-full bg-white overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto px-5 sm:px-8 md:px-10 lg:px-14 xl:px-16 py-20 sm:py-14 md:py-16 lg:pt-20 lg:pb-[30px]">
                ...
                <div className="w-full bg-[#F3F3F1] grid grid-cols-1 lg:grid-cols-2 items-start lg:gap-6 bg-[#F3F3F1] rounded-[30px] overflow-hidden p-30 sm:p-5 md:p-6 lg:pt-[20px]">
