                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
                    ...
                    <div className="flex flex-col justify-between min-h-[200px]">
                        ...
                        <div>
                            ...
                            {/* SOCIAL */}
                            <div className="flex items-center gap-3 mt-6 mb-8 ml-1">
                                ...
                                >
                                    {/* <img
                                        src={facebook}
                                        alt="facebook"
                                        className="w-[11px] cursor-pointer opacity-90 hover:opacity-100 transition"
                                    /> */}
                                    <svg width="27px" height="27px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none"><path fill="#1877F2" d="M15 8a7 7 0 00-7-7 7 7 0 00-1.094 13.915v-4.892H5.13V8h1.777V6.458c0-1.754 1.045-2.724 2.644-2.724.766 0 1.567.137 1.567.137v1.723h-.883c-.87 0-1.14.54-1.14 1.093V8h1.941l-.31 2.023H9.094v4.892A7.001 7.001 0 0015 8z" /><path fill="#ffffff" d="M10.725 10.023L11.035 8H9.094V6.687c0-.553.27-1.093 1.14-1.093h.883V3.87s-.801-.137-1.567-.137c-1.6 0-2.644.97-2.644 2.724V8H5.13v2.023h1.777v4.892a7.037 7.037 0 002.188 0v-4.892h1.63z" /></svg>
                                ...
                                >
                                    {/* <img
                                        src={instagram}
                                        alt="instagram"
                                        className="w-[20px] cursor-pointer opacity-90 hover:opacity-100 transition"
                                    /> */}
                                    <svg width="27px" height="27px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="text-white text-[22px] mt-4 mb-3 font-bold">
                                <p>Security & Compliance</p>
                            </div>


                            <div className="border-white flex max-w-[157px] flex-1 items-center rounded-[12px] border px-2 py-1 mt-2">
                            ...
                            <div className="flex max-w-[250px] flex-1 items-center px-1 py-1 mt-2">
                                <div className="flex items-center gap-3">

                                    <p className="text-left text-[17px] leading-[1.3] tracking-[-0.01em] text-[#f4eee7] ">
                                        <span className="block">Hosted on AWS</span>
                                    </p>

                                    <div className="relative h-14 w-14 shrink-0 mt-2">

                                        <svg width="50px" height="50px" viewBox="0 -30 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {/* <div className="text-white text-[17px] font-thin mt-8">
                                <p>Hosted on AWS</p>
                            </div> */}
