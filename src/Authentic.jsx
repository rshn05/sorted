...
function Authentic() {
  return (
    <section className="relative w-full overflow-hidden bg-white">
      <h2 className="text-2xl -mt-[25px] ml-[220px] sm:text-3xl md:text-4xl lg:text-[52px] font-bold text-black leading-tight tracking-[-1px] sm:mb-6 relative top-[120px] z-10">
        Authentic</h2>
